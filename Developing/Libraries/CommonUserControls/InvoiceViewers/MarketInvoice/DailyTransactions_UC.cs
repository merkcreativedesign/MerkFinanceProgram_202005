...
{
	public partial class DailyTransactions_UC : 
		//UserControl
		...
		ICashBoxInOutTransactionViewer, IViewerDataRelated
	{
		...
		public DailyTransactions_UC()
		{
			InitializeComponent();

			CommonViewsActions.LoadXMLFromString(layoutControl1,
				Resources.LocalizedRes.lyt_CashBoxInOutTransaction_Viewer);
		...
		private void DailyTransactions_UC_KeyUp(object sender, KeyEventArgs e)
		{
