...
namespace MarketInvoiceCreation
{
	public partial class InvoiceActions_UC : UserControl
	{
		...
		{
			BaseController<FinanceInvoice>.ShowEditorControl(ref _marketInvoiceCreation, 
				this,
				DB_InvoiceType.PurchasingInvoice, 
				null, 
				EditorContainerType.Regular, 
				ViewerName.FinanceInvoiceCreation_Viewer,
				DB_CommonTransactionType.CreateNew, 
				"فـاتــــــورة المشتـريــــــات", 
				true);
		}
		...
		private void btnSellingInvoice_Click(object sender, System.EventArgs e)
		{
			BaseController<FinanceInvoice>.ShowEditorControl(ref _marketInvoiceCreation, this,
				DB_InvoiceType.SellingInvoice,
				null, EditorContainerType.Regular, ViewerName.FinanceInvoiceCreation_Viewer,
				DB_CommonTransactionType.CreateNew,
		...
		private void btnReturningPurchasingInvoice_Click(object sender, System.EventArgs e)
		{
			BaseController<FinanceInvoice>.ShowEditorControl(ref _marketInvoiceCreation, this,
				...
				ViewerName.FinanceInvoiceCreation_Viewer, DB_CommonTransactionType.CreateNew,
				"فـاتــــــورة مــــردودات المشتـريــــــات", true);
		}

		private void btnReturningSellingInvoice_Click(object sender, System.EventArgs e)
		{
			BaseController<FinanceInvoice>.ShowEditorControl(ref _marketInvoiceCreation, this,
				DB_InvoiceType.ReturningSellingInvoice,
				null, EditorContainerType.Regular, ViewerName.FinanceInvoiceCreation_Viewer,
				DB_CommonTransactionType.CreateNew,
